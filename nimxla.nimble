...
task makedocs, "build the docs":
  ...
  for file in @["src/nimxla.nim", "src/nimxla/tensor.nim", "src/nimxla/literal.nim", "src/nimxla/shape.nim", "src/nimxla/graph.nim", "src/nimxla/nn.nim", "src/nimxla/data.nim", "src/nimxla/train.nim"]:
